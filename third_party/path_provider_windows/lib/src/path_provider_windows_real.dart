...
class PathProviderWindows extends PathProviderPlatform {
  ...
  String _getApplicationSpecificSubdirectory() {
    ...
    try {
      ...
      // DayVector is a public rename of an installed application, not a new
      // data namespace. Keep this immutable compatibility path so an upgrade
      // continues to see preferences, avatars, and browser profiles created
      // by earlier releases even though VERSIONINFO now says DayVector.
      companyName = 'pro.taskmaster';
